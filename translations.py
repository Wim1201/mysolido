TRANSLATIONS = {
    "nl": {
        ...
        "bridge_auto_sync_on": "Aan — start 2 seconden na een bestandswijziging in de kluis (uploaden, verwijderen, verplaatsen, delen). Intenties, verzoeken en toestemmingen synchroniseren niet vanzelf; het kopiëren zelf kan enkele minuten duren.",
        "bridge_auto_sync_off": "Uit — synchroniseer met de knop hieronder (BRIDGE_AUTO_SYNC=true in .env zet auto-sync aan, alleen voor bestandswijzigingen)",
        "bridge_sync_refreshing": "de status ververst vanzelf",
        ...
        "error_403_heading": "Geen toegang",
        "error_403_text": "Deze pagina is hier niet beschikbaar.",
        "error_403_bridge": "Deze pagina is niet beschikbaar op de Bridge. De Bridge is alleen-lezen; beheren doe je in je lokale MySolido.",
        "error_404_heading": "Pagina niet gevonden",
        "error_404_text": "Dit adres bestaat niet (meer). Controleer de link.",
        ...
        "int_share_attr_desc": "Vink per gegeven aan wat bij deze intentie hoort. De huidige waarde staat ernaast; bij opslaan wordt die waarde vastgelegd. Bij de gekozen categorie zijn de passende gegevens al voorgeselecteerd.",
        "int_terms_title": "Voorwaarden (MyTerms)",
        "int_purpose": "Doel",
        "int_no_onward_transfer": "Doorlevering aan derden niet toegestaan",
        "int_no_onward_transfer_hint": "Standaard aan: de ontvanger mag de gegevens niet doorgeven.",
        "int_offer_mode": "Aanbodvorm",
        "int_offer_open": "Open aanbod",
        "int_offer_open_hint": "iedereen die de voorwaarden accepteert",
        "int_offer_targeted": "Gericht aanbod",
        "int_offer_targeted_hint": "aan één benoemde partij",
        "int_targeted_party": "Naam van de partij",
        "int_targeted_party_placeholder": "Bijv. Verzekeraar X",
        "int_snapshot_title": "Vastgelegde gegevens",
        "int_snapshot_note": "Vastgelegd op {date}; wijzigingen in je profiel daarna staan hier niet in.",
        "int_snapshot_empty": "Bij deze intentie zijn geen gegevens vastgelegd.",
        "int_legacy_note": "Oudere intentie (per groep vastgelegd). Deze weergave toont je huidige profiel, geen momentopname.",
        "int_onward_prohibited": "Niet toegestaan",
        "int_onward_allowed": "Toegestaan",
        "int_onward_transfer": "Doorlevering aan derden",
        "int_targeted_to": "Gericht aanbod aan",
        "flash_targeted_party_required": "Vul de naam van de partij in bij een gericht aanbod.",
        "flash_attributes_required": "Vink minstens één ingevuld gegeven aan. Zonder gegevens is er geen aanbod op te stellen.",
        "flash_policy_created": "Voorwaarden opgesteld.",
        "flash_policy_no_attributes": "Deze intentie bevat geen vastgelegde gegevens; er zijn geen voorwaarden op te stellen.",
        "int_policy_title": "Voorwaarden (ODRL-aanbod)",
        "int_policy_file": "Bekijk als bestand (JSON-LD)",
        "int_policy_missing": "Voor deze intentie zijn nog geen voorwaarden opgesteld.",
        "int_policy_create": "Voorwaarden opstellen",
        "int_policy_none": "Voor deze intentie zijn geen voorwaarden: er zijn geen gegevens vastgelegd.",
        "int_accepted_by_title": "Geaccepteerd door",
        "int_accepted_by_line": "{party} op {date}",
        "int_accepted_by_note": "Op deze intentie rust een Agreement; ze kan niet meer worden verwijderd.",
        "flash_intention_has_agreements": "Deze intentie is geaccepteerd door een wederpartij en kan niet worden verwijderd.",
        "flash_consent_has_agreement": "Op deze toestemming rust een Agreement; ze kan worden ingetrokken, maar niet verwijderd.",
        "consent_has_agreement_note": "Op deze toestemming rust een Agreement; ze kan worden ingetrokken, maar niet verwijderd. Het record blijft als bewijs van de afspraak.",
        "flash_accept_terms_required": "Vink aan dat u de voorwaarden accepteert.",
        "flash_intention_not_active": "Deze intentie is niet actief; accepteren is nu niet mogelijk.",
        "flash_bridge_accept_blocked": "Accepteren loopt via de lokale kluis van de eigenaar, niet via de Bridge.",
        "flash_no_terms": "Voor deze intentie zijn geen voorwaarden opgesteld.",
        "flash_request_confirmed": "Acceptatie bevestigd; de Agreement met {name} is vastgelegd.",
        "flash_request_already_handled": "Dit verzoek is al afgehandeld.",
        "req_accepted": "Geaccepteerd",
        "req_awaiting": "Wacht op bevestiging",
        "req_status_awaiting_desc": "Uw acceptatie is ontvangen en wacht op bevestiging door de eigenaar van de kluis.",
        "req_status_accepted_desc": "U heeft de voorwaarden geaccepteerd. De gedeelde gegevens staan achter onderstaande link.",
        "req_int_title": "Voorwaarden accepteren",
        "req_int_intro": "De eigenaar van deze kluis biedt onderstaande gegevens aan onder deze voorwaarden. Na acceptatie ontvangt u de waarden.",
        "req_int_terms": "Voorwaarden (ODRL-aanbod)",
        "req_int_attributes": "Gegevens in dit aanbod",
        "req_int_no_values": "De waarden worden pas na acceptatie getoond.",
        "req_int_accept_label": "Ik accepteer deze voorwaarden ({uid})",
        "req_int_submit": "Voorwaarden accepteren",
        "req_int_not_active": "Deze intentie is niet actief (status: {status}). De voorwaarden zijn te lezen, maar accepteren is nu niet mogelijk.",
        "req_int_bridge": "Accepteren loopt via de lokale kluis van de eigenaar; via de Bridge kunt u de voorwaarden alleen lezen.",
        "req_int_not_found": "Intentie niet gevonden",
        "req_int_no_terms": "Voor deze intentie zijn geen voorwaarden opgesteld.",
        "req_int_targeted_note": "Dit is een gericht aanbod aan {name}. Na uw acceptatie bevestigt de eigenaar dat u die partij bent.",
        "req_int_accepted_title": "Voorwaarden geaccepteerd",
        "req_int_accepted_desc": "Uw acceptatie is vastgelegd. Via onderstaande knop ziet u de gedeelde gegevens; bewaar ook de statuslink.",
        "req_int_awaiting_desc": "Uw acceptatie is vastgelegd en wacht op bevestiging door de eigenaar. Via de statuslink ziet u wanneer de gegevens beschikbaar zijn.",
        "req_acceptance_title": "Acceptatie en Agreement",
        "req_party": "Wederpartij",
        "req_accepted_at": "Geaccepteerd op",
        "req_accepted_policy": "Geaccepteerde voorwaarden",
        "req_policy_hash": "Hash van het aanbod bij acceptatie",
        "req_agreement": "Agreement",
        "req_agreement_file": "Bekijk Agreement (JSON-LD)",
        "req_agreement_pending": "Nog geen Agreement: wacht op uw bevestiging.",
        "req_confirm_party": "Bevestig dat deze partij de benoemde partij is ({name}). Daarmee ontstaat de Agreement en krijgt de partij de gegevens.",
        "req_confirm_btn": "Bevestigen (goedkeuren)",
        "req_resp_terms": "Voorwaarden",
        "req_resp_agreement": "Agreement",
        "req_withdrawn": "Toestemming ingetrokken",
        "req_withdrawn_on": "Toestemming ingetrokken op {date}",
        "time_local_note": "Nederlandse tijd; in het record in UTC",
        "req_withdrawn_desc": "De eigenaar van de kluis heeft de toestemming ingetrokken. De gegevens zijn niet meer beschikbaar; de afspraak (Agreement) blijft als bewijs bestaan.",
        "req_consent_record": "Consentrecord",
        "req_consent_view": "Bekijk consentrecord",
        "req_shared_values": "Gedeelde waarden",
        "req_int_identity_note": "De identiteit van de wederpartij wordt niet geverifieerd: naam, organisatie en e-mailadres zijn zelf opgegeven.",
        "req_int_intro_inactive": "De eigenaar van deze kluis heeft deze voorwaarden opgesteld. Ze zijn hier te lezen; accepteren is op dit moment niet mogelijk.",
        "req_int_intro_bridge": "De eigenaar van deze kluis heeft deze voorwaarden opgesteld. U leest ze hier; accepteren gebeurt via de lokale kluis van de eigenaar, niet via de Bridge.",
        "int_withdraw_offer": "Aanbod intrekken",
        "int_offer_link": "Aanbodlink",
        "int_offer_link_hint": "Geef deze link aan de wederpartij; daar leest ze de voorwaarden en accepteert ze.",
        "int_offer_link_hint_bridge": "Geef deze link aan de wederpartij; daar leest ze de voorwaarden. Accepteren gebeurt via de lokale kluis van de eigenaar, niet via de Bridge.",
        "int_copy": "Kopieer",
        "int_copied": "Gekopieerd",
        "int_confirm_withdraw_offer": "Aanbod intrekken? Er kunnen dan geen nieuwe acceptaties meer volgen. Lopende afspraken blijven bestaan; toestemming trek je per afspraak in bij Toestemmingen.",
        "int_accepted_withdrawn": "(toestemming ingetrokken op {date})",
        "consent_category": "Intentie:",
        "consent_27560_title": "Toestemming (ISO/IEC TS 27560)",
        "consent_27560_party": "Wederpartij (verwerkingsverantwoordelijke)",
        "consent_27560_contact": "Contactpersoon",
        "consent_27560_purpose": "Doel",
        "consent_27560_data": "Gedeelde gegevens",
        "consent_27560_validity": "Geldigheid",
        "consent_27560_end_of_offer": "de einddatum van het aanbod (schema:validThrough van de intentie; de Agreement heeft geen eigen einddatum)",
        "consent_27560_onward": "Doorlevering aan derden",
        "consent_27560_onward_prohibited": "Niet toegestaan (prohibition in de Agreement)",
        "consent_27560_onward_permitted": "Toegestaan",
        "consent_27560_events": "Gebeurtenissen",
        "consent_27560_event_given": "Toestemming gegeven",
        "consent_27560_event_withdrawn": "Toestemming ingetrokken",
        "consent_27560_status": "Status (DPV)",
        "consent_27560_legal_basis": "Rechtsgrond",
        "consent_27560_jurisdiction": "Jurisdictie",
        "consent_27560_links": "Koppelingen",
        "consent_27560_link_intention": "Intentie",
        "consent_27560_link_request": "Verzoek",
        "consent_27560_link_agreement": "Agreement (JSON-LD)",
        "consent_27560_schema": "Conform",
        "flash_attribute_invalid": "Het veld '{label}' is ongeldig en is niet opgeslagen.",
        ...
        "pd_personal": "Persoonlijk",
        "pd_age_category": "Leeftijdscategorie",
        "pd_postal_area": "Postcodegebied (4 cijfers)",
        "pd_postal_area_placeholder": "Bijv. 5611",
        "pd_claims_history": "Schadeverleden",
        "pd_claim_free_years": "Schadevrije jaren",
        "pd_claims_last_3_years": "Schade geclaimd in de laatste 3 jaar",
        "pd_yes": "Ja",
        "pd_no": "Nee",
    ...
    "en": {
        ...
        "bridge_auto_sync": "Auto-sync",
        "bridge_auto_sync_on": "On — starts 2 seconds after a file change in the vault (upload, delete, move, share). Intentions, requests and consents do not sync by themselves; copying itself can take a few minutes.",
        "bridge_auto_sync_off": "Off — sync with the button below (BRIDGE_AUTO_SYNC=true in .env enables auto-sync, for file changes only)",
        "bridge_sync_refreshing": "the status refreshes by itself",
        ...
        "error_403_heading": "No access",
        "error_403_text": "This page is not available here.",
        "error_403_bridge": "This page is not available on the Bridge. The Bridge is read-only; manage your vault in your local MySolido.",
        "error_404_heading": "Page not found",
        "error_404_text": "This address does not exist (anymore). Check the link.",
        ...
        "int_share_attr_desc": "Tick each item that belongs to this intention. The current value is shown next to it; saving records that value. The matching items for the chosen category are pre-selected.",
        "int_terms_title": "Terms (MyTerms)",
        "int_purpose": "Purpose",
        "int_no_onward_transfer": "No onward transfer to third parties",
        "int_no_onward_transfer_hint": "On by default: the recipient may not pass the data on.",
        "int_offer_mode": "Offer type",
        "int_offer_open": "Open offer",
        "int_offer_open_hint": "anyone who accepts the terms",
        "int_offer_targeted": "Targeted offer",
        "int_offer_targeted_hint": "to one named party",
        "int_targeted_party": "Name of the party",
        "int_targeted_party_placeholder": "E.g. Insurer X",
        "int_snapshot_title": "Recorded data",
        "int_snapshot_note": "Recorded on {date}; later changes to your profile are not included here.",
        "int_snapshot_empty": "No data was recorded with this intention.",
        "int_legacy_note": "Older intention (recorded per group). This view shows your current profile, not a snapshot.",
        "int_onward_prohibited": "Not allowed",
        "int_onward_allowed": "Allowed",
        "int_onward_transfer": "Onward transfer to third parties",
        "int_targeted_to": "Targeted offer to",
        "flash_targeted_party_required": "Enter the name of the party for a targeted offer.",
        "flash_attributes_required": "Tick at least one filled-in item. Without data there is no offer to draw up.",
        "flash_policy_created": "Terms drawn up.",
        "flash_policy_no_attributes": "This intention has no recorded data; there are no terms to draw up.",
        "int_policy_title": "Terms (ODRL offer)",
        "int_policy_file": "View as file (JSON-LD)",
        "int_policy_missing": "No terms have been drawn up for this intention yet.",
        "int_policy_create": "Draw up terms",
        "int_policy_none": "This intention has no terms: no data was recorded.",
        "int_accepted_by_title": "Accepted by",
        "int_accepted_by_line": "{party} on {date}",
        "int_accepted_by_note": "An Agreement rests on this intention; it can no longer be deleted.",
        "flash_intention_has_agreements": "This intention has been accepted by a counterparty and cannot be deleted.",
        "flash_consent_has_agreement": "An Agreement rests on this consent; it can be withdrawn, but not deleted.",
        "consent_has_agreement_note": "An Agreement rests on this consent; it can be withdrawn, but not deleted. The record remains as evidence of the agreement.",
        "flash_accept_terms_required": "Tick the box to accept the terms.",
        "flash_intention_not_active": "This intention is not active; accepting is not possible now.",
        "flash_bridge_accept_blocked": "Accepting is done through the owner's local vault, not through the Bridge.",
        "flash_no_terms": "No terms have been drawn up for this intention.",
        "flash_request_confirmed": "Acceptance confirmed; the Agreement with {name} has been recorded.",
        "flash_request_already_handled": "This request has already been handled.",
        "req_accepted": "Accepted",
        "req_awaiting": "Awaiting confirmation",
        "req_status_awaiting_desc": "Your acceptance has been received and awaits confirmation by the vault owner.",
        "req_status_accepted_desc": "You accepted the terms. The shared data is behind the link below.",
        "req_int_title": "Accept terms",
        "req_int_intro": "The owner of this vault offers the data below under these terms. After acceptance you receive the values.",
        "req_int_terms": "Terms (ODRL offer)",
        "req_int_attributes": "Data in this offer",
        "req_int_no_values": "Values are shown only after acceptance.",
        "req_int_accept_label": "I accept these terms ({uid})",
        "req_int_submit": "Accept terms",
        "req_int_not_active": "This intention is not active (status: {status}). You can read the terms, but accepting is not possible now.",
        "req_int_bridge": "Accepting is done through the owner's local vault; through the Bridge you can only read the terms.",
        "req_int_not_found": "Intention not found",
        "req_int_no_terms": "No terms have been drawn up for this intention.",
        "req_int_targeted_note": "This is a targeted offer to {name}. After your acceptance the owner confirms that you are that party.",
        "req_int_accepted_title": "Terms accepted",
        "req_int_accepted_desc": "Your acceptance has been recorded. Use the button below to view the shared data; keep the status link too.",
        "req_int_awaiting_desc": "Your acceptance has been recorded and awaits confirmation by the owner. The status link shows when the data becomes available.",
        "req_acceptance_title": "Acceptance and Agreement",
        "req_party": "Counterparty",
        "req_accepted_at": "Accepted on",
        "req_accepted_policy": "Accepted terms",
        "req_policy_hash": "Hash of the offer at acceptance",
        "req_agreement": "Agreement",
        "req_agreement_file": "View Agreement (JSON-LD)",
        "req_agreement_pending": "No Agreement yet: awaiting your confirmation.",
        "req_confirm_party": "Confirm that this party is the named party ({name}). This creates the Agreement and releases the data to the party.",
        "req_confirm_btn": "Confirm (approve)",
        "req_resp_terms": "Terms",
        "req_resp_agreement": "Agreement",
        "req_withdrawn": "Consent withdrawn",
        "req_withdrawn_on": "Consent withdrawn on {date}",
        "time_local_note": "Dutch time; stored in the record in UTC",
        "req_withdrawn_desc": "The vault owner has withdrawn consent. The data is no longer available; the Agreement remains as evidence.",
        "req_consent_record": "Consent record",
        "req_consent_view": "View consent record",
        "req_shared_values": "Shared values",
        "req_int_identity_note": "The counterparty's identity is not verified: name, organisation and e-mail address are self-declared.",
        "req_int_intro_inactive": "The owner of this vault drew up these terms. They can be read here; accepting is not possible at the moment.",
        "req_int_intro_bridge": "The owner of this vault drew up these terms. You read them here; accepting is done through the owner's local vault, not through the Bridge.",
        "int_withdraw_offer": "Withdraw offer",
        "int_offer_link": "Offer link",
        "int_offer_link_hint": "Give this link to the counterparty; there they read the terms and accept.",
        "int_offer_link_hint_bridge": "Give this link to the counterparty; there they read the terms. Accepting is done through the owner's local vault, not through the Bridge.",
        "int_copy": "Copy",
        "int_copied": "Copied",
        "int_confirm_withdraw_offer": "Withdraw the offer? No new acceptances can follow. Existing agreements remain; consent is withdrawn per agreement under Consents.",
        "int_accepted_withdrawn": "(consent withdrawn on {date})",
        "consent_category": "Intention:",
        "consent_27560_title": "Consent (ISO/IEC TS 27560)",
        "consent_27560_party": "Counterparty (data controller)",
        "consent_27560_contact": "Contact person",
        "consent_27560_purpose": "Purpose",
        "consent_27560_data": "Shared data",
        "consent_27560_validity": "Validity",
        "consent_27560_end_of_offer": "the end date of the offer (schema:validThrough of the intention; the Agreement has no end date of its own)",
        "consent_27560_onward": "Onward transfer to third parties",
        "consent_27560_onward_prohibited": "Not allowed (prohibition in the Agreement)",
        "consent_27560_onward_permitted": "Allowed",
        "consent_27560_events": "Events",
        "consent_27560_event_given": "Consent given",
        "consent_27560_event_withdrawn": "Consent withdrawn",
        "consent_27560_status": "Status (DPV)",
        "consent_27560_legal_basis": "Legal basis",
        "consent_27560_jurisdiction": "Jurisdiction",
        "consent_27560_links": "Links",
        "consent_27560_link_intention": "Intention",
        "consent_27560_link_request": "Request",
        "consent_27560_link_agreement": "Agreement (JSON-LD)",
        "consent_27560_schema": "Conforms to",
        "flash_attribute_invalid": "The field '{label}' is invalid and was not saved.",
        ...
        "pd_personal": "Personal",
        "pd_age_category": "Age category",
        "pd_postal_area": "Postal code area (4 digits)",
        "pd_postal_area_placeholder": "E.g. 5611",
        "pd_claims_history": "Claims history",
        "pd_claim_free_years": "Claim-free years",
        "pd_claims_last_3_years": "Claims filed in the last 3 years",
        "pd_yes": "Yes",
        "pd_no": "No",
        "settings_ocr": "OCR provider",
        ...
        "flash_bridge_readonly": "This action is not available via the Bridge. Use your local MySolido.",
        "flash_wrong_password": "Incorrect password",
        "flash_sync_not_configured": "Bridge sync is not configured. Set BRIDGE_HOST in your .env file.",
        "flash_sync_started": "Synchronization started...",
        "flash_access_expired": "Access of {webid} to \"{name}\" has expired and been revoked",
        "flash_no_file_selected": "No file selected",
        "flash_upload_success": "\"{filename}\" uploaded successfully!",
        "flash_upload_failed_save": "Upload failed: could not save file",
        "flash_upload_failed": "Upload failed",
        "flash_no_resource": "No resource specified",
        "flash_folder_deleted": "Folder \"{name}\" deleted",
        "flash_delete_failed": "Deletion failed",
        "flash_delete_invalid_path": "Deletion failed: invalid path",
        "flash_delete_not_found": "Deletion failed: file not found",
        "flash_trash_failed": "Moving to trash failed",
        "flash_trash_success": "\"{name}\" moved to trash",
        "flash_invalid_folder_name": "Invalid folder name",
        "flash_folder_exists": "Folder \"{name}\" already exists",
        "flash_folder_created": "Folder \"{name}\" created!",
        "flash_folder_create_failed": "Failed to create folder",
        "flash_no_file_specified": "No file specified",
        "flash_already_in_folder": "File is already in this folder",
        "flash_move_not_found": "Move failed: file not found",
        "flash_move_invalid_target": "Move failed: invalid target path",
        "flash_move_success": "\"{filename}\" moved to {target}",
        "flash_file_open_failed": "File could not be opened",
        "flash_file_download_failed": "File could not be downloaded",
        "flash_fill_webid": "Enter a WebID or choose public",
        "flash_share_success": "\"{name}\" shared with {webid}",
        "flash_share_failed": "Sharing failed",
        "flash_file_not_found": "File not found",
        "flash_link_revoked": "Share link revoked",
        "flash_link_not_found": "Share link not found",
        "flash_invalid_request": "Invalid request",
        "flash_access_revoked": "Access of {webid} to \"{name}\" revoked",
        "flash_trash_item_not_found": "Item not found in trash",
        "flash_restore_invalid_path": "Restore failed: invalid path",
        "flash_restore_not_found": "Restore failed: file not found in trash",
        "flash_restore_invalid_target": "Restore failed: invalid target path",
        "flash_restore_success": "\"{filename}\" restored to {folder}",
        "flash_permanent_delete": "\"{filename}\" permanently deleted",
        "flash_password_too_short": "Password must be at least 8 characters",
        "flash_password_changed": "Bridge password changed",
        "flash_css_password_changed": "Solid password changed",
        "flash_css_password_change_failed": "Password change failed — check your current credentials",
        "flash_css_password_unavailable": "Solid password is not available in plain text",
        "flash_css_unreachable": "Community Solid Server is unreachable",
        "flash_not_available_bridge": "Not available in Bridge mode",
        "flash_watermark_status": "Watermarks {status}",
        "flash_crash_status": "Error reports {status}",
        "flash_invalid_choice": "Invalid choice",
        "flash_api_key_required": "Enter an API key to use hybrid mode",
        "flash_ai_provider_set": "AI provider set to {label}",
        "flash_mistral_key_required": "Enter a Mistral API key to use Cloud OCR",
        "flash_ocr_provider_set": "OCR provider set to {label}",
        "flash_backup_failed": "Backup failed: {error}",
        "flash_folder_init_failed": "Failed to create folder \"{folder}\"",
        "flash_vault_ready": "Your vault is set up! Upload your first document.",
        "flash_no_folders_created": "No folders created",
        "flash_folder_not_found": "Folder not found",
        "flash_policy_updated": "Policy updated for {name}",
        "flash_title_receiver_required": "Title and recipient are required",
        "flash_consent_saved": "Consent \"{title}\" recorded",
        "flash_consent_folder_not_found": "Consent folder not found",
        "flash_consent_not_found": "Consent not found",
        "flash_consent_withdrawn": "Consent \"{title}\" withdrawn",
        "flash_consent_deleted": "Consent deleted",
        "flash_profile_saved": "Profile data saved",
        "flash_description_required": "Description is required",
        "flash_intention_saved": "Intention \"{label}\" saved as draft",
        "flash_intentions_not_found": "Intentions folder not found",
        "flash_intention_not_found": "Intention not found",
        "flash_intention_activated": "Intention activated",
        "flash_intention_withdrawn": "Intention withdrawn",
        "flash_intention_deleted": "Intention deleted",
        "flash_rate_limit": "Too many requests. Please try again later.",
        "flash_required_fields": "Name, email address and explanation are required.",
        "flash_agree_terms": "You must agree to the terms.",
        "flash_select_data": "Select at least one data group.",
        "flash_invalid_email": "Enter a valid email address.",
        "flash_requests_not_found": "Requests folder not found",
        "flash_request_not_found": "Request not found",
        "flash_select_data_share": "Select at least one data group to share.",
        "flash_request_approved": "Request from {name} approved.",
        "flash_approve_failed": "Approval failed",
        "flash_request_rejected": "Request from {name} rejected.",
        "flash_report_deleted": "Report deleted",
        "flash_report_not_found": "Report not found",
        "flash_original_location": "original location",
        "flash_watermark_on": "enabled",
        "flash_watermark_off": "disabled",
        "pd_rent": "Rent",
        "pd_buy": "Own",
        "pd_other": "Other",
        "pd_apartment": "Apartment",
        "pd_terraced": "Terraced house",
        "pd_corner": "Corner house",
        "pd_detached": "Detached",
        "pd_age_0_4": "0 – 4 years",
        "pd_age_5_12": "5 – 12 years",
        "pd_age_13_17": "13 – 17 years",
        "pd_age_18plus": "18+ years",
        "pd_car": "Car",
        "pd_motorcycle": "Motorcycle",
        "pd_scooter": "Scooter",
        "pd_bicycle": "Bicycle",
        "pd_none": "None",
        "pd_petrol": "Petrol",
        "pd_diesel": "Diesel",
        "pd_electric": "Electric",
        "pd_hybrid_fuel": "Hybrid",
        "pd_na": "N/A",
        "pd_ins_health": "Health insurance",
        "pd_ins_car": "Car insurance",
        "pd_ins_home": "Home insurance",
        "pd_ins_travel": "Travel insurance",
        "pd_ins_liability": "Liability",
        "pd_ins_legal": "Legal aid",
        "pd_sector_ict": "ICT",
        "pd_sector_healthcare": "Healthcare",
        "pd_sector_education": "Education",
        "pd_sector_construction": "Construction",
        "pd_sector_government": "Government",
        "pd_sector_finance": "Finance",
        "pd_sector_retail": "Retail",
        "pd_employed": "Employed",
        "pd_freelance": "Freelance",
        "pd_entrepreneur": "Entrepreneur",
        "pd_retired": "Retired",
        "pd_student": "Student",
        "pd_smoking_yes": "Yes",
        "pd_smoking_no": "No",
...
def t(key, lang=None, **kwargs):
    """Haal een vertaling op met optionele string formatting"""
    if lang is None:
        try:
